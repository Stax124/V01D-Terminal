...
if platform.system() == "Linux":
    ...
    LinuxCompleter = WordCompleter(list(dict.fromkeys(l + ["tcp-scan", "autoclicker", "threads", "instaloader", "play", "player-volume", "player-terminate", "player-pause", "back", "currencyconverter", "downloadeta", "sizeof", "md5", "sha1", "sha224", "sha256", "sha384", "sha512", "void", "plain2string", "eval", "welcome", "help", "elevate", "admin", "compile",
